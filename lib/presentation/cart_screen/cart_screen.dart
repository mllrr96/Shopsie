...
class CartScreen extends GetWidget<CartController> {
                          ...
                          child: Padding(
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    ...
                                    Obx(() => Text(controller.cartModelObj.value.priceTwoTxt.value,
                                        overflow: TextOverflow.ellipsis,
                                        textAlign: TextAlign.left,
                                        style: AppStyle.txtLatoRegular18.copyWith(letterSpacing: 1.08)))
                                  ]))),
  ...
  void _onDeleteLineItemsSuccess() {
    ...
    controller.cartModelObj.value.priceTwoTxt.value = controller.deleteLineItemsResp.cart!.subtotal!.toString();
  ...
  void _onCreateLineItemsSuccess() {
    ...
    if (controller.postLineItemsResp!.cart!.items! != null && controller.postLineItemsResp!.cart!.items!.isNotEmpty) {
    ...
    controller.cartModelObj.value.cartItemList.value = cartItemModelList;
    controller.cartModelObj.value.priceTwoTxt.value = controller.postLineItemsResp.cart!.subtotal!.toString();
